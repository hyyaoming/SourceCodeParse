package org.lym.sourcecodeparse.source.parse.loading;
...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_loading_view_size, dp2px(context, LOADING_SIZE));
